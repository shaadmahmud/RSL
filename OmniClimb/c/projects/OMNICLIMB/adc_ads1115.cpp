...
PICO_ADS1115 ads;						 // 16 bit ADS1015 instance
uint16_t I2CSpeed = 400;		 // I2C speed in Khz
uint8_t DataGPIO = 8;			 // I2C GPIO for data line
uint8_t ClockGPIO = 9;			 // I2C GPIO for Clock line
...
int main()
{
	...
	busy_wait_ms(1000);
	printf("ADS1115 : Start Single End example.\r\n");
